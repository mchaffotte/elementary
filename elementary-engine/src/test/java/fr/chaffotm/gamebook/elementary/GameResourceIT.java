...
public class GameResourceIT {
    ...
    public void playGame() {
        ...
        given()
            ...
            .then()
                .statusCode(200)
                .body(is("{\"data\":{\"startGame\":{\"section\":{\"reference\":0,\"paragraphs\":[\"You are locked in a room.\",\"The only visible exit is the door.\"],\"actions\":[{\"id\":254,\"description\":\"If you want to open the door\"},{\"id\":191,\"description\":\"Or inspect the shelves\"}]}}}}"));
